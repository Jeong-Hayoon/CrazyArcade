...
//
//		// 각 맵에 따른 화면
//		Texture* ForestMap2 = Resources::Load<Texture>(L"ForestMapImage"
//			, L"..\\Resources\\Image\\Bg\\ForestTile.bmp");
//		BackGround* forestmap2 = object::Instantiate<BackGround>(eLayerType::Background);
//		forestmap2->GetComponent<Transform>()->SetPosition(Vector2(480.0f, 410.0f));
//		SpriteRenderer* forestmapsr = forestmap2->AddComponent<SpriteRenderer>();
//		forestmapsr->SetImage(ForestMap2);
//		forestmapsr->SetScale(Vector2(1.0f, 0.90f));
//
//		// 배찌 상하좌우 애니메이션
//		Bazzi* forestbazzi2 = object::Instantiate<Bazzi>(eLayerType::Player);
//		forestbazzi2->GetComponent<Transform>()->SetPosition(Vector2(60.0f, 70.0f));
//
//		// 배찌 프로필
...
//		// 포레스트 몬스터
//		
//		* ForestMonster_1 = object::Instantiate<ForestMonster_1_1>(eLayerType::Player);
//		ForestMonster_1_1->GetComponent<Transform>()->SetPosition(Vector2(100.0f, 70.0f));
//
//		Scene::Initialize();
//	}
